...
////////////////////////////////////////////////////////////////////////////
//
//	ProductCategories Tree View
//

// Tell Fiori about the structure of the hierarchy
annotate AdminService.ProductCategories with @Aggregation.RecursiveHierarchy #ProductCategoriesHierarchy : {
  ParentNavigationProperty : parent, // navigates to a node's parent
  NodeProperty             : ID, // identifies a node, usually the key
};

// Fiori expects the following to be defined explicitly, even though they're always the same
extend AdminService.ProductCategories with @(
  // The columns expected by Fiori to be present in hierarchy entities
  Hierarchy.RecursiveHierarchy #ProductCategoriesHierarchy : {
